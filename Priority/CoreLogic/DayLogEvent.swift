...
enum DayLogEventKind: String, Codable, Sendable {
  case completed
  case reopened
...
struct DayLogEvent: Codable, Equatable, Sendable {
  let kind: DayLogEventKind
  let at: Date
  let taskId: Int
  let title: String
  ...
  static func completed(taskId: Int, title: String, at: Date) -> DayLogEvent {
    DayLogEvent(kind: .completed, at: at, taskId: taskId, title: title)
  }

  static func reopened(taskId: Int, title: String, at: Date) -> DayLogEvent {
    DayLogEvent(kind: .reopened, at: at, taskId: taskId, title: title)
  }

  static func invalidated(taskId: Int, title: String, at: Date) -> DayLogEvent {
    DayLogEvent(kind: .invalidated, at: at, taskId: taskId, title: title)
  }

  static func focusSessionEnded(taskId: Int, title: String, seconds: Int, at: Date) -> DayLogEvent {
    DayLogEvent(
  ...
  static func deferred(taskId: Int, title: String, at: Date) -> DayLogEvent {
  ...
  static func dailyCompleted(dailyId: String, title: String, at: Date) -> DayLogEvent {
    DayLogEvent(kind: .dailyCompleted, at: at, taskId: 0, title: title, dailyId: dailyId)
  }

  static func dailyUncompleted(dailyId: String, title: String, at: Date) -> DayLogEvent {
  ...
  static func planSnapshot(taskIds: [Int], at: Date) -> DayLogEvent {
    DayLogEvent(
      kind: .planSnapshot,
      at: at,
      taskId: 0,
