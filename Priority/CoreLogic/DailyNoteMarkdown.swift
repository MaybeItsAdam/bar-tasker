...
enum DailyNoteMarkdown {
  static let beginMarker = "<!-- priority:begin -->"
  static let endMarker = "<!-- priority:end -->"
  ...
  static func merged(section: String, into existing: String) -> String {
    guard
