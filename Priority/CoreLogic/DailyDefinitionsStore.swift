...
final class DailyDefinitionsStore {
  ...
  init(directoryURL: URL, fileName: String = "dailies.json") {
  ...
  func save(_ collection: DailyCollection) throws {
    do {
  ...
  @discardableResult
  func mutate(_ transform: (inout DailyCollection) -> Void) throws -> DailyCollection {
  ...
  func loadLocked() throws -> DailyCollection {
